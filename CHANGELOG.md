...
### Added
- Added functionality to get schemas directory path
- Added simple `tokamap` CLI to return schemas directory path and version

### Changed
- Flattened the directory structure for better organization

[0.1.0]: https://github.com/ukaea/tokamap/releases/tag/v0.1.0
[0.2.0]: https://github.com/ukaea/tokamap/releases/tag/v0.2.0
